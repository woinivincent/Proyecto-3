...
import { updateUserCount, initSlider } from "../../Components/Utils/Slider"; // Importa las funciones necesarias desde Slider.js
import './Home.css'
...
function Home() {
    ...
    useEffect(() => {
        updateUserCount(); // Actualiza el contador de elementos en el carrito
